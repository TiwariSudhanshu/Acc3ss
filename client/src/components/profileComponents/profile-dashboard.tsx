 ...
 const getOwnedTickets = async () => {
  try {
    ...
    for (const ticket of currentUser.ticketsOwned) {
      ...
      let organizerName = metadata?.communityName || metadata?.organizerName || "Event Organizer"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-6">
              {activeTab === "attended" && (
                <EventsAttended eventsAttended={eventsAttended} isLoading={isLoadingAttended} />
              )}
      ...
      <TicketModal isOpen={isTicketModalOpen} onClose={closeTicketModal} selectedTicket={selectedTicket} />
