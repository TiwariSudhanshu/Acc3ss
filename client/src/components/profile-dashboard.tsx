      ...
      for (const eventId of currentUser.eventsCreated) {
        ...
        events.push({
          ...
          image: metadata?.bannerImage
            ? convertIPFSToHTTP(metadata.bannerImage)
            : "/placeholder.svg",
          date: dateTime.date,
          time: dateTime.time,
  ...
  const eventsAttended: Event[] = [
    {
      ...
      image:
        "https://i.pinimg.com/736x/25/f6/66/25f666ddb218a20d09534fe0d01494af.jpg",
      date: "Dec 15, 2024",
      time: "9:00 AM",
    ...
    },
    {
      ...
      image:
        "https://i.pinimg.com/736x/fc/2d/e9/fc2de95d90362735b9c3ffd8620b6ae7.jpg",
      date: "Nov 20, 2024",
      time: "6:00 PM",
    ...
    },
    {
      ...
      image:
        "https://i.pinimg.com/736x/70/c8/3c/70c83c57dbf1514e7dd8b363a63327fe.jpg",
      date: "Oct 22, 2024",
      time: "7:00 PM",
      location: "Austin, TX",
      price: "Free",
                ...
                <div>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                      ...
                      } bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center`}
                    >
                      <Plus className="w-4 h-4 mr-2" />
